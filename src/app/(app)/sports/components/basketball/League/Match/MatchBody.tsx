...
import { basketballMainMarkets, basketballBetBuilder, basketballMainProps, basketballTeamProps, basketballQuarterProps, basketballHalfProps } from './mappings/datastructure';
