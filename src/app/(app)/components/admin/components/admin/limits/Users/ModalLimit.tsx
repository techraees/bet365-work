...
const ModalLimit = ({ tableList, userName }: { tableList: any, userName: string }) => {
  const { isLimitModalOpen, closeLimitModal } = useModalContext();
  const [sport, setSport] = useState("Football");
  const [group, setGroup] = useState("All Groups");

  return (
    <Modal
      className="modal-user-limit"
      title={"Limits For: " + userName}
