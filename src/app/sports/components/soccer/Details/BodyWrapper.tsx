...
import { soccerAll } from './soccerfakedata';
...
import {doubleChance, fulltimeResult} from './mapping'
...
const BodyWrapper: React.FC<MarketGroupProps> = ({ data, active }) => {
    ...
    oddData['fulltimeResult'].rows= fulltimeResult(data);
    oddData['doubleChance'].rows= doubleChance(data);
    console.log({oddData})
    return (
