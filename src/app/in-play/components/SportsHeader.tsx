...
const SportsHeader = () => {
  ...
  return (
    <div className="bg-brand-dark-grey ">
      {" "}
      <div className=" flex gap-[25px] max-w-[1500px] px-8 py-4 border-b-2 border-[#408058]">
        {menuLinks.map((link, index) => {
          ...
          return (
            <CustomLink
              href={link.link}
              className={cn("group-hover:text-white text-sm leading-[0px] text-[11px]",isActive && "text-white underline underline-offset-[10px] decoration-[#81FFB1] decoration-2" )}
              key={index}
            >
              <div
                className={cn(
