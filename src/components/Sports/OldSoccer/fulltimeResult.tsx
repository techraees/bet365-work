...
const FulltimeResult: React.FC<FulltimeResultProps> = ({ data }) => {
    ...
    return (
        <>
            <div className={cn("flex items-center", suspend === "0" ? 'hover:bg-[hsla(0,0%,100%,.15)] cursor-pointer' : '')}>
            ...
            <div className={cn("flex items-center flex-row-reverse", suspend === "0" ? 'hover:bg-[hsla(0,0%,100%,.15)] cursor-pointer' : '')}>
                <div className="bg-[hsla(0,0%,100%,.1)] w-[1px] h-[50px]" />
