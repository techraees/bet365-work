...
const TennisMarketGroup: React.FC<MarketGroupProps> = ({ data, active }) => {
    ...
    if (active === "All") {
        ...
        {
            oddData.nextSetRaceTo.marketname = getNextSetTitle(data, oddData.nextSetRaceTo.marketname);
        ...
        {
            oddData.nextSetLeadAfter.marketname = getNextSetTitle(data, oddData.nextSetLeadAfter.marketname);
        ...
        {
            oddData.nextSetScoreAfter4Games.marketname = getNextSetTitle(data, oddData.nextSetScoreAfter4Games.marketname);
        ...
        {
            oddData.nextSetScoreAfter6Games.marketname = getNextSetTitle(data, oddData.nextSetScoreAfter6Games.marketname);
        ...
        {
            oddData.currentSetScoreAfter6Games.marketname = getSetTitle(data, oddData.currentSetScoreAfter6Games.marketname);
        ...
        {
            oddData.nextSetHandicap.marketname = getNextSetTitle(data, oddData.nextSetHandicap.marketname);
        ...
        {
            oddData.setBetting.marketname = getSetTitle(data, oddData.goTheDistance.marketname);
        ...
        {
            oddData.playerGamesWon.marketname = getSetTitle(data, oddData.playerGamesWon.marketname);
        ...
        {
            oddData.nextSetWinner.marketname = getNextSetTitle(data, oddData.nextSetWinner.marketname);
