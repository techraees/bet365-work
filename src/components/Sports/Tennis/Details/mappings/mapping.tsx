...
export const toWin = (data: any) => {
  ...
  if (odds_final_winner !== undefined) {
    ...
    var title_row_obj = {
      title: "Match",
      value: null,
      suspend: odds_final_winner.suspend,
    };
    ...
    base_arr.push(arr);
    console.log(base_arr, "base url here");
  }
...
export const pointBetting = (data: any) => {
  ...
  for (var group in grouped) {
    ...
    if (
      grouped_obj["Home"] === undefined ||
      grouped_obj["Away"] === undefined
    ) {
      continue;
    }
...
const _gameScoreCreateRow = (
  ...
  for (var participant_id in participants) {
    ...
    if (
      participant_obj.name == home_score_string &&
      parseInt(participant_obj.handicap) === parseInt(handicap)
    ) {
      var obj = {
        title: "",
    ...
    if (
      participant_obj.name == away_score_string &&
      parseInt(participant_obj.handicap) === parseInt(handicap)
    ) {
      var obj = {
        title: "",
...
export const nextGameWinner = (data: any) => {
  ...
  for (var participant_id in participants) {
    ...
    if (
      participant_obj.name === "Home" &&
      parseInt(participant_obj.handicap) === current_game
    ) {
...
const _getParticipantsField = (
  ...
  for (var participant_id in participants) {
    ...
    const participant_obj = participants[participant_id];
    if (
      parseInt(participant_obj.handicap) === handicap &&
      participant_obj.name === line
    ) {
      title = participant_obj.name;
      suspend = participant_obj?.suspend;
      value = participant_obj.value_eu;
...
export const gameScoreAfter3Points = (data: any) => {
  ...
  var participants = odds.participants;
  var firstRow = [
    _getParticipantsField(participants, "30-15", current_game),
    _getParticipantsField(participants, "15-30", current_game),
  ];
  var secondRow = [
    _getParticipantsField(participants, "40-0", current_game),
    _getParticipantsField(participants, "0-40", current_game),
  ];
...
export const gameScoreAfter4Points = (data: any) => {
  ...
  var participants = odds.participants;
  var firstRow = [
    _getParticipantsField(participants, "W-0", current_game),
    _getParticipantsField(participants, "30-30", current_game),
    _getParticipantsField(participants, "0-W", current_game),
  ];
  var secondRow = [
    _getParticipantsField(participants, "40-15", current_game),
    { title: "", value: "", suspend: "0" },
    _getParticipantsField(participants, "15-40", current_game),
  ];
  if (firstRow.includes(null) == false && secondRow.includes(null) == false) {
    base_arr.push(firstRow);
    base_arr.push(secondRow);
...
export const gameTotalPoints = (data: any) => {
  ...
  var participants = odds.participants;
  var firstRow = [
    _getParticipantsField(participants, "4 Points", current_game),
    _getParticipantsField(participants, "5 Points", current_game),
  ];
  var secondRow = [
    _getParticipantsField(participants, "6 Points", current_game),
    _getParticipantsField(participants, "Over 6 points", current_game),
  ];
  if (firstRow.includes(null) == false && secondRow.includes(null) == false) {
    base_arr.push(firstRow);
    base_arr.push(secondRow);
...
export const nextGameToHaveBreakpoint = (data: any) => {
  ...
  var participants = odds.participants;
  var firstRow = [
    _getParticipantsField(participants, "Yes", current_game),
    _getParticipantsField(participants, "No", current_game),
  ];
...
export const nextToGamesEitherGameToDeuce = (data: any) => {
  ...
  var participants = odds.participants;
  var firstRow = [
    _getParticipantsFieldWithoutHandicap(participants, "Yes"),
    _getParticipantsFieldWithoutHandicap(participants, "No"),
  ];
  if (firstRow.includes(null) == false) {
    base_arr.push(firstRow);
  }
...
export const totalGamesInCurrentSet = (data: any) => {
  ...
  for (var handicap in groupedParticipants) {
    ...
    if (
      grouped_obj["Over"] === undefined ||
      grouped_obj["Under"] === undefined
    ) {
      continue;
    }
    var arr = [] as any;
    ...
    var over_obj = {
      title: "",
      value: grouped_obj["Over"][0].value_eu,
      suspend: grouped_obj["Over"][0].suspend,
    };
    var under_obj = {
      title: "",
      value: grouped_obj["Under"][0].value_eu,
...
export const raceToCurrentSet = (data: any) => {
  ...
  for (var handicap in groupedParticipants) {
    ...
    if (grouped_obj["Home"] && grouped_obj["Away"]) {
      var home_obj = {
        title: "",
        value: grouped_obj["Home"][0].value_eu,
        suspend: grouped_obj["Home"][0].suspend,
      };
      var away_obj = {
        title: "",
        value: grouped_obj["Away"][0].value_eu,
...
export const leadAfterCurrentSet = (data: any) => {
  ...
  for (var handicap in groupedParticipants) {
    ...
    var home_obj = {
      title: "",
      value: grouped_obj["1"][0].value_eu,
      suspend: grouped_obj["1"][0].suspend,
    };
    var away_obj = {
      title: "",
      value: grouped_obj["2"][0].value_eu,
      suspend: grouped_obj["2"][0].suspend,
    };
    var tie_obj = {
      title: "",
      value: grouped_obj["X"][0].value_eu,
...
export const correctScoreCurrentSet2 = (data: any) => {
  ...
  for (const key in participants) {
    if (
      participants.hasOwnProperty(key) &&
      namesToRemove.includes(participants[key].name)
    ) {
...
export const currentSetTieBreakTotalPoints = (data: any) => {
  ...
  for (var handicap in group) {
    ...
    arr.push({
      title: "",
      value: over_participant.value_eu,
      suspend: over_participant.suspend,
    });
    arr.push({
      title: "",
      value: under_participant.value_eu,
...
export const playersOverUnder = (data: any) => {
  ...
  var suspend_value = "0";
  if (
    player_1_over_participant.suspend === "1" &&
    player_1_under_participant.suspend === "1" &&
    player_2_over_participant.suspend === "1" &&
    player_2_under_participant.suspend === "1"
  ) {
    suspend_value = "1";
  }
  var suspend_value = areAllSuspended(base_arr);
...
export const _groupSetBetting = (participants: {
...
export const player1To = (data: any) => {
  ...
  var _odd_id_current_set_winner = findIdByName(data, search_line);
  var player_1_to_win_in_straight_sets_odds =
    data?.odds[_odd_id_current_set_winner];
  if (player_1_to_win_in_straight_sets_odds !== undefined) {
    ...
    var player_1_to_win_in_straight_sets_title = {
      title: "Win in Straight Sets",
      value: "",
      suspend: "",
    };
    var player_1_to_win_in_straight_sets_yes_obj = {
      title: "",
      value: player_1_to_win_in_straight_sets_yes.value_eu,
      suspend: player_1_to_win_in_straight_sets_yes.suspend,
    };
    var player_1_to_win_in_straight_sets_no_obj = {
      title: "",
      value: player_1_to_win_in_straight_sets_no.value_eu,
    ...
    var player_1_to_win_in_straight_sets_arr = [
      ...
      player_1_to_win_in_straight_sets_yes_obj,
      player_1_to_win_in_straight_sets_no_obj,
    ];
  ...
  if (player_1_to_win_a_set_odds !== undefined) {
    ...
    var player_1_to_win_a_set_yes_obj = {
      title: "",
      value: player_1_to_win_a_set_yes.value_eu,
      suspend: player_1_to_win_a_set_yes.suspend,
    };
    var player_1_to_win_a_set_no_obj = {
      title: "",
      value: player_1_to_win_a_set_no.value_eu,
      suspend: player_1_to_win_a_set_no.suspend,
    };
    var player_1_to_win_a_set_arr = [
      player_1_to_win_a_set_title,
      player_1_to_win_a_set_yes_obj,
      player_1_to_win_a_set_no_obj,
    ];
  ...
  if (player_1_to_win_from_behind_odds !== undefined) {
    ...
    var player_1_to_win_from_behind_yes_obj = {
      title: "",
      value: player_1_to_win_from_behind_yes.value_eu,
      suspend: player_1_to_win_from_behind_yes.suspend,
    };
    var player_1_to_win_from_behind_no_obj = {
      title: "",
      value: player_1_to_win_from_behind_no.value_eu,
      suspend: player_1_to_win_from_behind_no.suspend,
    };
    var player_1_to_win_from_behind_arr = [
      player_1_to_win_from_behind_title,
      player_1_to_win_from_behind_yes_obj,
      player_1_to_win_from_behind_no_obj,
    ];
...
export const currentSetLeadAfter2 = (data: any) => {
  ...
  for (var group of groups) {
    var arr = [] as any;
    var title_obj = {
      title: starting_value.toString(),
      value: "",
      suspend: "1",
    };
    var home_obj = {
      title: "",
      value: group["Home"].value_eu,
      suspend: group["Home"].suspend,
    };
    var away_obj = {
      title: "",
      value: group["Away"].value_eu,
...
export const matchHandicap = (data: any) => {
  ...
  var away_participant = _getParticipantsFieldRaw(participants, "Away");
  var home_obj = {
    title: data?.team_info?.home?.name + " " + home_participant.handicap,
    value: home_participant.value_eu,
    suspend: home_participant.suspend,
  };
  var away_obj = {
...
export const doubleResult = (data: any) => {
  ...
  if (
    player_1_win_win !== null &&
    player_1_win_lose !== null &&
    player_2_win_win !== null &&
    player_2_win_lose !== null
  ) {
    var player_1_win_win_obj = {
      title:
    ...
    var player_1_win_lose_obj = {
      title:
        ...
        current_period_str +
        " and LOSE match",
      value: player_1_win_lose.value_eu,
    ...
    var player_2_win_win_obj = {
      title:
        ...
        current_period_str +
        " and WIN match",
      value: player_2_win_win.value_eu,
...
export const matchResultAndTotalGames = (data: any) => {
  ...
  var player_1_row_title = {
    title: data?.team_info?.home.name,
    value: "",
    suspend: player_1_over_participant.suspend,
  };
  var player_1_over_participant_obj = {
  ...
  arr1 = [
    player_1_row_title,
    player_1_over_participant_obj,
    player_1_under_participant_obj,
  ];

  arr2 = [
    player_2_row_title,
    player_2_over_participant_obj,
    player_2_under_participant_obj,
  ];
  base_arr.push(arr1);
  base_arr.push(arr2);
  var suspend_value = areAllSuspended(base_arr);
