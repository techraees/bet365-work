...
interface BasketballMobilePitchInterface {
  data: any;
  onlyPitch: boolean;
}
...
const BasketballMobilePitch: React.FC<BasketballMobilePitchInterface> = ({
  data,
  onlyPitch,
}) => {
  const initialSeconds = data?.info?.seconds || "00:00";
  const [activeTab, setActiveTab] = useState("Live"); // Default to 'Stats'
  ...
  const renderPitch = () => (
    ...
    >
      ...
      >
        ...
        <g fill="none" fillRule="evenodd">
          <g fill="#DB9F86" transform="translate(2.000000, 80.000000)">
            <path d="M11.696 4.562l-.09.207c-.076.173-.156.365-.238.57-.257.636-.5 1.298-.72 1.966-.384 1.166-.67 2.265-.846 3.275-.136.78-.205 1.492-.205 2.137 0 3.115.422 4.724 2.098 8.152l.133.045.29-.142.045-.134c-1.64-3.36-2.043-4.893-2.044-7.923 0-.613.065-1.297.196-2.046.172-.983.452-2.058.828-3.2.216-.658.455-1.31.708-1.935.08-.2.16-.39.232-.56l.087-.197-.048-.133-.293-.133-.134.05z"></path>
      ...
      {status?.team == 1 &&
        (status?.status == "Free Throw Scored" ||
          status?.status == "Free Throw Missed" ||
          status?.status == "Free Throw") && (
          <g
            id="SVGIRIS_PITCH_TEAM_1"
            transform="matrix(1,0,0,1,305,66)"
            opacity="1"
          >
            <rect
            ...
            ></rect>
            <text
              id="SVGIRIS_PITCH_TEAM_1_TXT_TEAM"
              x="-5"
              y="14"
              fill="#663b29"
              font-family="Roboto"
            ...
            <text
              id="SVGIRIS_PITCH_TEAM_1_TXT_ACTION"
              x="-5"
              y="32"
              fill="#ffffff"
              font-family="Roboto"
            ...
            <text
              id="SVGIRIS_PITCH_TEAM_1_TXT_INFO"
              x="-5"
              y="47"
              fill="#663b29"
              font-family="Roboto"
      ...
      {status?.status == "Free Throw Missed" && (
        <>
          {/* ball point */}
          <g
            id="SVGIRIS_PITCH_DEF_POINT"
            opacity={1}
            transform={
              status?.team == 1
                ? "matrix(1,0,0,1,321,91)"
                : "matrix(1,0,0,1,79,91)"
            }
          >
            <g
              id="SVGIRIS_PITCH_DEF_POINT_G"
          ...
          <g
            ...
            className={
              status?.team == 1
                ? basketballAnimation.ballHomeFreeThrowMissed
                : basketballAnimation.ballAwayFreeThrowMissed
            }
          >
              ...
              <g id="SvgjsG1271">
                <g id="SvgjsG1269">
                  ...
                  <circle
                    ...
                    cy="48.156"
                    r="48.125"
                    fill="url(#SVGIRIS_PITCH_DEF_BALL_GRAD)"
                  ></circle>
                </g>
                <g id="SvgjsG1251">
                  <path
      ...
      {status?.team == 1 && status?.status == "Free Throw" && (
        <g
          id="SVGIRIS_PITCH_DEF_POINT"
          opacity={1}
          transform="matrix(1,0,0,1,321,91)"
        >
          <g
            id="SVGIRIS_PITCH_DEF_POINT_G"
            transform="translate(-60,-60)"
      ...
      {status?.team == 2 && status?.status == "Free Throw" && (
        <g
          id="SVGIRIS_PITCH_DEF_POINT"
          opacity={1}
          transform="matrix(1,0,0,1,79,91)"
        >
          <g
            id="SVGIRIS_PITCH_DEF_POINT_G"
            transform="translate(-60,-60)"
      ...
      {status?.team == 1 && status?.status == "In Possession" && (
        <>
          ...
          <g
            id="SVGIRIS_PITCH_TEAM_1"
            transform="matrix(1,0,0,1,250,74)"
            opacity="1"
          >
            <rect
              id="SVGIRIS_PITCH_TEAM_1_COL"
        ...
        <>
            ...
            <g id="SvgjsG1534" transform="matrix(-1,0,0,1,300,0)">
              ...
              >
                ...
                >
                  ...
                  >
                    <g
                      transform="translate(-589.000000, -112.000000)"
                      id="SvgjsG1558"
                    >
                      <g
                        transform="translate(592.000000, 115.000000)"
                        id="SvgjsG1556"
                      >
                        <ellipse
                          stroke="#FFFFFF"
                ...
                >
                  ...
                  >
                    <g
                      transform="translate(-69.000000, -112.000000)"
                      id="SvgjsG1542"
                    >
                      <g
                        transform="translate(72.000000, 115.000000)"
                        id="SvgjsG1540"
                      >
                        <circle
                          stroke="#FFFFFF"
          ...
          {status?.team == 1 ? (
            <g
              ...
              transform="matrix(1,0,0,1,223,74)"
              opacity="1"
            >
              <rect
              ...
              ></rect>
              <text
                id="SVGIRIS_PITCH_TEAM_2_TXT_TEAM"
                x="-8"
                y="14"
                fill="#663b29"
                fontFamily="Roboto"
              ...
              <text
                id="SVGIRIS_PITCH_TEAM_2_TXT_ACTION"
                x="-8"
                y="32"
                fill="#ffffff"
                fontFamily="Roboto"
            ...
            <g
              id="SVGIRIS_PITCH_TEAM_2"
              transform="matrix(1,0,0,1,177,74)"
              opacity="1"
            >
              <rect
                id="SVGIRIS_PITCH_TEAM_2_COL"
      ...
      {status?.status == "Timeout" && (
        <>
          <g
            ...
            opacity="1"
            transform={
              status?.team == 1 ? "translate(235, 76)" : "translate(135, 76)"
            }
          >
            <ellipse
              stroke="#fff"
      ...
      {status?.team == 1 && status?.status == "Score 3 points" && (
        <>
          ...
          <g
            id="SVGIRIS_PITCH_TEAM_2"
            transform="matrix(1,0,0,1,270,74)"
            opacity="1"
          >
            <rect
              id="SVGIRIS_PITCH_TEAM_2_COL"
      ...
      {status?.team == 2 && status?.status == "Score 3 points" && (
        <>
          ...
          <g
            id="SVGIRIS_PITCH_TEAM_2"
            transform="matrix(1,0,0,1,130,74)"
            opacity="1"
          >
            <rect
              id="SVGIRIS_PITCH_TEAM_2_COL"
      ...
      {status?.status == "Score 3 points" && (
        <>
          ...
          <g
            ...
            transform={
              status?.team == 1
                ? "matrix(1,0,0,1,287,91)"
                : "matrix(1,0,0,1,113,91)"
            }
          >
            <g
              id="SVGIRIS_PITCH_DEF_POINT_G"
          ...
          <g
            ...
            className={
              status?.team == 1
                ? basketballAnimation.ballHomePoint3
                : basketballAnimation.ballAwayPoint3
            }
          >
            <g id="SVGIRIS_PITCH_FX_BALL">
              <g id="SvgjsG1271">
      ...
      {status?.team == 1 && status?.status == "Score 2 points" && (
        <>
          ...
          <g
            id="SVGIRIS_PITCH_TEAM_2"
            transform="matrix(1,0,0,1,306,74)"
            opacity="1"
          >
            <rect
              id="SVGIRIS_PITCH_TEAM_2_COL"
      ...
      {status?.team == 2 && status?.status == "Score 2 points" && (
        <>
          ...
          <g
            id="SVGIRIS_PITCH_TEAM_2"
            transform="matrix(1,0,0,1,94,74)"
            opacity="1"
          >
            <rect
              id="SVGIRIS_PITCH_TEAM_2_COL"
      ...
      {(status?.status == "Score 2 points" ||
        ...
        <>
          ...
          <g
            ...
            className={
              status?.team == 1
                ? basketballAnimation.ballHomePoint2
                : basketballAnimation.ballAwayPoint2
            }
          >
            <g id="SVGIRIS_PITCH_FX_BALL">
              <g id="SvgjsG1271">
      ...
      <g id="SVGIRIS_PITCH_DEF_BALL" style={{ display: "none" }}>
        <g transform="matrix(.1 0 0 .1 -4.8 -4.8)">
          <g id="Layer_2">
            <radialGradient
              id="SVGIRIS_PITCH_DEF_BALL_GRAD"
              cx="37.25"
              cy="31.531"
              r="60.208"
              gradientUnits="userSpaceOnUse"
          ...
          <g>
            ...
            <path d="m53.375 87.031c-5.658-1.547-12.604-5.717-19.406-8.984-6.576-3.163-13.266-5.547-18.594-6.328-0.746-0.091-1.415-0.128-2.019-0.128-3.712 0.017-5.156 1.55-5.507 2.157-0.114 0.208-0.24 0.361-0.24 0.361l-0.641-0.969c0.118-0.211 1.048-3.719 6.362-3.682 0.645 0 1.355 0.041 2.138 0.135 6.431 0.764 12.721 3.534 19.313 6.703 6.84 3.294 13.508 7.41 18.953 8.891 5.518 1.502 6.957 2.277 11 2.281 7.688 0.016 13.333-1.619 13.344-1.625l-0.922 0.672c-0.022 2e-3 -6.453 2.375-12.484 2.25-4.124 3e-3 -5.814-0.236-11.297-1.734z"></path>
          </g>
          <g>
            <path d="m14.784 59.765c-2.852-0.418-7.341-1.532-10.897-2.874-3.569-1.338-3.418-2.031-3.418-2.031s-0.281-1.25-0.375-3.625c0 0 1.094 1.016 1.828 1.438 0.484 0.399 1.663 0.943 3.172 1.516l-0.146-0.102c3.275 1.243 7.717 2.345 10.267 2.709 4.551 0.662 12.027 1.169 21.671 1.169 1.034 0 2.095-7e-3 3.181-0.017 11.139-0.118 28.42-1.545 39.081-4.126 9.351-2.256 14.547-5.279 15.563-5.873 0.132-0.085 1.542-0.771 1.542-0.771 0.5-0.219 0.38 2.88-0.104 3.208-0.145 0.103-5.232 3.684-16.295 6.354-11.09 2.67-28.392 4.076-39.755 4.208-1.096 9e-3 -2.165 0.015-3.211 0.017-9.759-3e-3 -17.323-0.508-22.104-1.2z"></path>
          </g>
        </g>
      </g>
      <svg
        id="SVGIRIS_PITCH_DEF_COLLECTION"
        width="40"
        height="40"
        viewBox="0 0 40 40"
        x="180"
      ...
      >
        ...
        <svg
          id="SVGIRIS_PITCH_DEF_COLLECTION_TTOU"
          width="40"
          height="40"
          viewBox="0 0 36 36"
          version="1.1"
        ...
        <svg
          id="SVGIRIS_PITCH_DEF_COLLECTION_TFOU"
          width="40"
          height="40"
          viewBox="0 0 36 36"
          version="1.1"
    ...
    <>
      {onlyPitch && (
        <div className="flex flex-col w-full p-0">
          <div className="flex-auto flex items-stretch w-full mx-0 my-0 max-h-[calc(100vh_-_500px)] overflow-y-auto">
            <div className="block max-w-none flex-auto w-full mx-0 my-0">
              <div className="max-w-[440px] mx-0 my-0 px-0 py-0">
                {renderPitch()}
              </div>
            </div>
          </div>
...
export default BasketballMobilePitch;
