...
interface SoccerMobilePitchInterface {
  data: any;
  onlyPitch: boolean;
}
...
function getStatusFromCode(code: number): string | undefined {
  const soccerCodes = [
    ...
    {
      code: 11004,
      name: "Home Team Corner",
    },
    {
      code: 21004,
      name: "Away Team Corner",
    },
    {
      code: 11007,
      name: "Home Team Goal kick",
    },
    {
      code: 21007,
      name: "Away Team Goal kick",
    },
    {
      code: 11008,
    ...
    {
      code: 11025,
      name: "Home Team Injury",
    },
    {
      code: 21025,
      name: "Away Team Injury",
    },
    {
      code: 1237,
      name: "Zoned Throw",
    ...
    {
      code: 11237,
      name: "Home Team Zoned Throw",
    },
    {
      code: 21237,
      name: "Away Team Zoned Throw",
    },
    {
      code: 1234,
      name: "Offside",
    ...
    {
      code: 11234,
      name: "Home Team Offside",
    },
    {
      code: 21234,
      name: "Away Team Offside",
    },
    {
      code: 1238,
      name: "Substitution",
    ...
    {
      code: 11332,
      name: "Home Team VAR - Reviewing Goal",
    },
    {
      code: 21332,
      name: "Away Team VAR - Reviewing Goal",
    },
    {
      code: 1331,
      name: "VAR - Reviewing Red Card",
    },
    {
      code: 11331,
      name: "Home Team VAR - Reviewing Red Card",
    },
    {
      code: 21331,
      name: "Away Team VAR - Reviewing Red Card",
    },
    {
      code: 1333,
    ...
    {
      code: 21931,
      name: "Away Team Freekick - Pos. 7",
    },
    {
      code: 21933,
      name: "Away Team Freekick - Pos. 8",
    },
    {
      code: 21935,
      name: "Away Team Freekick - Pos. 9",
    },
    {
      code: 21932,
      name: "Away Team Freekick - Pos. 10",
    },
    {
      code: 21934,
      name: "Away Team Freekick - Pos. 11",
    },
    {
      code: 21936,
      name: "Away Team Freekick - Pos. 12",
    },
    {
      code: 11301,
      name: "Home Team TakeOnAttack",
    },
    {
      code: 21300,
      name: "Away Team TakeOnDangerousAttack",
    },
    {
      code: 11302,
      name: "Home Team TakeOnSafePossession",
    },
    {
      code: 1026,
      name: "InjuryTime",
    ...
    {
      code: 21301,
      name: "Away Team TakeOnAttack",
    },
    {
      code: 21016,
      name: "Away Team Secondhalf",
    },
    {
      code: 11300,
      name: "Home Team TakeOnDangerousAttack",
    },
    {
      code: 1000,
      name: "Danger",
    ...
    {
      code: 21026,
      name: "Away Team InjuryTime",
    },
    {
      code: 11016,
      name: "Home Team Secondhalf",
    },
    {
      code: 21302,
      name: "Away Team TakeOnSafePossession",
    },
    {
      code: 21014,
    ...
    {
      code: 21022,
      name: "Away Team Penaltyshootout",
    },
    {
      code: 11022,
      name: "Home Team Penaltyshootout",
    },
    {
      code: 1009,
      name: "Dfreekick",
...
const SoccerMobilePitch: React.FC<SoccerMobilePitchInterface> = ({
  data,
  onlyPitch,
}) => {
  //Status
    ...
    >
      ...
      {status?.team == 1 && status?.status == "Goal Kick" && (
        ...
        >
          <path
            id="goal_kick_3"
            className={soccerAnimation.kick2}
            fill="#165031"
            fillOpacity="0.3"
          ...
          <path
            id="goal_kick_2"
            className={soccerAnimation.kick1}
            fill="#165031"
            fillOpacity="0.5"
          ...
          <path
            id="goal_kick_1"
            className={soccerAnimation.kick0}
            fill="#165031"
            fillOpacity="0.7"
    ...
    ${ballPos?.y})`}
      ...
      {status?.team == 1 && status?.status == "Goal" && (
        <g
          id="goal"
          opacity="0"
          className={soccerAnimation.goal}
        ...
        <div className="flex flex-col w-full p-0">
          ...
          <div className="flex-auto flex items-stretch w-full mx-auto my-0 max-h-[calc(100vh_-_500px)] overflow-y-auto">
            <div className="block max-w-none flex-auto w-full mx-auto my-0">
              ...
              {activeTab == "Live" && (
                <div className="max-w-[440px] mx-0 my-0 px-5 py-2.5">
                  {renderPitch()}
                </div>
              )}
            </div>
