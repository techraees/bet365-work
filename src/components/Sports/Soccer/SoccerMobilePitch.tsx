...
const SoccerMobilePitch: React.FC<SoccerMobilePitchInterface> = ({ data }) => {
  //Status
              ...
              <>
                ...
                <div className="max-w-[440px] mx-auto my-0 px-5 py-2.5">
                  ...
                  >
                    ...
                    {status?.team == 1 &&
                      status?.status == "Dangerous Attack" && (
                        <g
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            ></path>
                            <path
                              d="M19.643 36.062l-2 .012"
                              id="SvgjsPath2315"
                            ></path>
                            <path
                              d="M26.733 31.135l-5-.089"
                              id="SvgjsPath2313"
                            ></path>
                            <path
                    ...
                    {ballPos && (
                      ...
                      >
                        <circle
                          ...
                          cy="0"
                          stroke={
                            status?.team == 1 ? kitColors.home : kitColors.away
                          }
                          strokeWidth="1.5"
                          fill="none"
                        />
