...
const SoccerMarketGroup: React.FC<MarketGroupProps> = ({ data, active }) => {
  ...
  if (active === "All") {
    ...
    soccerAll.gameWonInExtraTime.rows = twoCellTitleValue(
      data,
      "gameWonInExtraTime"
    );
    soccerAll.gameWonAfterPenaltiesShootout.rows = twoCellTitleValue(
      data,
    ...
    soccerAll.firstHalfAsianHandicap = firstHalfAsianHandicap(
      data,
      soccerAll.firstHalfAsianHandicap
    );
    soccerAll.firstHalfGoalLine = firstHalfGoalLine(
      data,
      soccerAll.firstHalfGoalLine
    );
    ...
    soccerAll.bothTeamsToScoreFirstHalf.rows = twoCellTitleValue(
      data,
      "bothTeamsToScoreFirstHalf"
    );
    soccerAll.bothTeamsToScoreSecondHalf.rows = twoCellTitleValue(
      data,
      "bothTeamsToScoreSecondHalf"
    );
    soccerAll.teamCleanSheet.rows = twoCellTitleValue(data, "teamCleanSheet");
    soccerAll.homeGoals = goalsOverUnder(
      data,
      soccerAll.homeGoals,
      "homeGoals"
    );
    soccerAll.awayGoals = goalsOverUnder(
      data,
      soccerAll.awayGoals,
      "awayGoals"
    );
    ...
    soccerBetBuilder.matchGoals = betMatchGoals(
      data,
      soccerBetBuilder.matchGoals
    );
    ...
    soccerBetBuilder.teamToScoreinBothHalf.rows =
      BetTeamToScoreinBothHalf(data);
    oddData = soccerBetBuilder as any;
  } else if (active === "Asian Lines") {
    soccerAsianLines.asianHandicap = asianHandicap(
      data,
      soccerAsianLines.asianHandicap
    );
    soccerAsianLines.goalLine.rows = goalLine(data);
    soccerAsianLines.firstHalfAsianHandicap = firstHalfAsianHandicap(
      data,
      soccerAsianLines.firstHalfAsianHandicap
    );
    soccerAsianLines.firstHalfGoalLine = firstHalfGoalLine(
      data,
      soccerAsianLines.firstHalfGoalLine
    );
    ...
    soccerCornersCards.matchCorners = matchCorners(
      data,
      soccerCornersCards.matchCorners
    );
    ...
    soccerHalf.firstHalfAsianHandicap = firstHalfAsianHandicap(
      data,
      soccerHalf.firstHalfAsianHandicap
    );
    soccerHalf.firstHalfGoalLine = firstHalfGoalLine(
      data,
      soccerHalf.firstHalfGoalLine
    );
    soccerHalf.firstHalfHandicap.rows = firstHalfHandicap(data);
    soccerHalf.firstHalfAsianCorners.rows = firstHalfAsianCorners(data);
    soccerHalf.bothTeamsToScoreSecondHalf.rows = twoCellTitleValue(
      data,
      "bothTeamsToScoreSecondHalf"
    );
