      ...
      items.map((item: any, index: number) => {
        ...
        if (row.length < 3 && title == "Home") {
          row.push({
            ...
            odd_id: 10000000000,
            odd_name: data?.odds?.[10000000000]?.name,
    ...
    if (items.length > 0) {
      items.map((item: any, index: number) => {
        ...
        if (row1.length == 0 && title == "1/1") {
          row1.push({
            title: `${data?.team_info?.home?.name} - ${data?.team_info?.home?.name}`,
            value: null,
            suspend: item[1].suspend,
          });
          row1.push({
            ...
            event_name:
              ...
              data?.team_info?.away?.name,
            odd_id: 951016311111,
            odd_name: data?.odds?.[951016311111]?.name,
            participant_id: item[1]?.id,
            participant_name: item[1]?.name,
            participant_handicap: item[1]?.handicap,
            participant_header: item[1]?.header,
        ...
        if (row1.length == 2 && title == "2/1") {
          row1.push({
            title: `${data?.team_info?.away?.name} - ${data?.team_info?.home?.name}`,
            value: null,
            suspend: item[1].suspend,
          });
          row1.push({
        ...
        if (row2.length == 0 && title == "1/2") {
          row2.push({
            title: `${data?.team_info?.home?.name} - ${data?.team_info?.away?.name}`,
            value: null,
            suspend: item[1].suspend,
          });
          row2.push({
        ...
        if (row2.length == 2 && title == "X/1") {
          row2.push({
            title: `Tie - ${data?.team_info?.home?.name}`,
            value: null,
            suspend: item[1].suspend,
          });
          row2.push({
        ...
        if (row3.length == 0 && title == "2/2") {
          row3.push({
            title: `${data?.team_info?.away?.name} - ${data?.team_info?.away?.name}`,
            value: null,
            suspend: item[1].suspend,
          });
          row3.push({
        ...
        if (row3.length == 2 && title == "X/2") {
          row3.push({
            title: `Tie - ${data?.team_info?.away?.name}`,
            value: null,
            suspend: item[1].suspend,
          });
          row3.push({
...
export const map1MapWinnerTotalRounds = (data: any) => {
  ...
  let row = [] as any;
  if (
    data?.odds?.[9510148]?.participants &&
    data?.odds?.[9510149]?.participants
  ) {
        ...
        if (row.length < 2 && title == "Over") {
          row.push({
            ...
            event_name:
              ...
              data?.team_info?.away?.name,
            odd_id: 9510148,
            odd_name: data?.odds?.[9510148]?.name,
            participant_id: item[1]?.id,
            participant_name: item[1]?.name,
            participant_handicap: item[1]?.handicap,
            participant_header: item[1]?.header,
        ...
        if (row.length > 1 && title == "Over") {
          row.push({
            ...
            event_name:
              ...
              data?.team_info?.away?.name,
            odd_id: 9510149,
            odd_name: data?.odds?.[9510149]?.name,
            participant_id: item[1]?.id,
            participant_name: item[1]?.name,
            participant_handicap: item[1]?.handicap,
            participant_header: item[1]?.header,
        ...
        if (row.length == 1) {
          row.push({
            ...
            event_name:
              ...
              data?.team_info?.away?.name,
            odd_id: 9209562,
            odd_name: data?.odds?.[9209562]?.name,
            participant_id: item[1]?.id,
            participant_name: item[1]?.name,
            participant_handicap: item[1]?.handicap,
            participant_header: item[1]?.header,
        ...
        if (row.length == 1) {
          row.push({
            ...
            event_name:
              ...
              data?.team_info?.away?.name,
            odd_id: 9290513,
            odd_name: data?.odds?.[9290513]?.name,
            participant_id: item[1]?.id,
            participant_name: item[1]?.name,
            participant_handicap: item[1]?.handicap,
            participant_header: item[1]?.header,
        ...
        if (row1.length == 0 && title == "1/1") {
          ...
          row1.push({
            ...
            event_name:
              ...
              data?.team_info?.away?.name,
            odd_id: 9510163,
            odd_name: data?.odds?.[9510163]?.name,
            participant_id: item[1]?.id,
            participant_name: item[1]?.name,
            participant_handicap: item[1]?.handicap,
            participant_header: item[1]?.header,
...
export const map2MapWinnerTotalRounds = (data: any) => {
  ...
  let row = [] as any;
  if (
    data?.odds?.[9510158]?.participants &&
    data?.odds?.[9510159]?.participants
  ) {
        ...
        if (row.length < 2 && title == "Over") {
          row.push({
            ...
            event_name:
              ...
              data?.team_info?.away?.name,
            odd_id: 9510158,
            odd_name: data?.odds?.[9510158]?.name,
            participant_id: item[1]?.id,
            participant_name: item[1]?.name,
            participant_handicap: item[1]?.handicap,
            participant_header: item[1]?.header,
        ...
        if (row.length > 1 && title == "Over") {
          row.push({
            ...
            event_name:
              ...
              data?.team_info?.away?.name,
            odd_id: 9510159,
            odd_name: data?.odds?.[9510159]?.name,
            participant_id: item[1]?.id,
            participant_name: item[1]?.name,
            participant_handicap: item[1]?.handicap,
            participant_header: item[1]?.header,
        ...
        if (row.length == 1) {
          row.push({
            ...
            event_name:
              ...
              data?.team_info?.away?.name,
            odd_id: 9209563,
            odd_name: data?.odds?.[9209563]?.name,
            participant_id: item[1]?.id,
            participant_name: item[1]?.name,
            participant_handicap: item[1]?.handicap,
            participant_header: item[1]?.header,
        ...
        if (row.length == 1) {
          row.push({
            ...
            event_name:
              ...
              data?.team_info?.away?.name,
            odd_id: 9290514,
            odd_name: data?.odds?.[9290514]?.name,
            participant_id: item[1]?.id,
            participant_name: item[1]?.name,
            participant_handicap: item[1]?.handicap,
            participant_header: item[1]?.header,
        ...
        if (toWin.length < 3 && (title === "Home" || title == "Away")) {
          toWin.push({
            ...
            event_name:
              ...
              data?.team_info?.away?.name,
            odd_id: 1182894,
            odd_name: data?.odds?.[1182894]?.name,
            participant_id: item[1]?.id,
            participant_name: item[1]?.name,
            participant_handicap: item[1]?.handicap,
            participant_header: item[1]?.header,
        ...
        if (toWin.length < 3 && (title === "Home" || title == "Away")) {
          toWin.push({
            ...
            event_name:
              ...
              data?.team_info?.away?.name,
            odd_id: 1182895,
            odd_name: data?.odds?.[1182895]?.name,
            participant_id: item[1]?.id,
            participant_name: item[1]?.name,
            participant_handicap: item[1]?.handicap,
            participant_header: item[1]?.header,
        ...
        if (toWin.length < 3 && (title === "Home" || title == "Away")) {
          toWin.push({
            ...
            event_name:
              ...
              data?.team_info?.away?.name,
            odd_id: 1182875,
            odd_name: data?.odds?.[1182875]?.name,
            participant_id: item[1]?.id,
            participant_name: item[1]?.name,
            participant_handicap: item[1]?.handicap,
            participant_header: item[1]?.header,
...
export const toWinAtLeastOneMap = (data: any) => {
  ...
  let row1 = [
    { title: data?.team_info?.home?.name, value: "", suspend: "0" },
  ] as any;
  let row2 = [
    { title: data?.team_info?.away?.name, value: "", suspend: "0" },
  ] as any;
