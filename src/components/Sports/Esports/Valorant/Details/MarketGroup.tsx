...
const ValorantMarketGroup: React.FC<MarketGroupProps> = ({ data, active }) => {
  ...
  if (active === "All") {
    //Map1FirstHalfWinnerIncTie
    valorantAll.Map1FirstHalfWinnerIncTie.rows =
      Map1FirstHalfWinnerIncTie(data);
    //Map1FirstHalfWinnerMapWinner
    valorantAll.Map1FirstHalfWinnerMapWinner.rows =
      Map1FirstHalfWinnerMapWinner(data);
    //map1ToGoToOverTime
    ...
    //Map2FirstHalfWinnerIncTie
    valorantAll.Map2FirstHalfWinnerIncTie.rows =
      Map2FirstHalfWinnerIncTie(data);
    //Map2FirstHalfWinnerMapWinner
    valorantAll.Map2FirstHalfWinnerMapWinner.rows =
      Map2FirstHalfWinnerMapWinner(data);
    //map2ToGoToOverTime
