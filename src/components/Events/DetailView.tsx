...
import {
  ...
  sportsDetailsMapping,
} from "@/lib/sportsMapping";
...
const DetailView: React.FC<DetailViewProps> = ({
  ...
  const inplayName =
    sportsDetailsMapping[sport as keyof typeof sportsDetailsMapping]?.name;
  // useEffect(() => {
  ...
  return (
    <div className="flex w-full flex-col">
      ...
      <div className="w-full">
        ...
        {sport === "lol" && <LolMarketGroup data={data} active={active} />}
        {sport === "dota2" && <Dota2MarketGroup data={data} active={active} />}
        {sport === "valorant" && (
          <ValorantMarketGroup data={data} active={active} />
        )}
        {sport === "cs2" && <Cs2MarketGroup data={data} active={active} />}
        {sport === "honorofkings" && (
